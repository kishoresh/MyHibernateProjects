...
/*
 * Inheritance Mapping - Single Table Per Heirarchy.
 * 3 Class : Parent Class - Employee have 2 subclasses - Regular Employee & Contract Employee
 * This mapping, will create a single table employee_tph with a Discriminator(Indicator) column 'Type' having values - emp, regular & contract. 
 * 
 */
...
public class Test {
	...
	public static void main(String[] args) {
		...
		try{
			SessionFactory sesFactory = new Configuration().configure("hibernate.inheritancemapping.TPH.cfg.xml").buildSessionFactory();
